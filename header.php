        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li id="signinli" class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Log In <i class="icon-angle-down"></i></a>
                        <ul class="dropdown-menu">
                        	<li><a href="#" data-toggle="modal" data-target="#modal3" >User</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#modal2" >Admin</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
		...
		<div class="modal-dialog">
			<div class="modal-content modal-popup" style="background:url(img/admin-body2.jpg)">
				...
				<form  class="popup-form">
					...
					<input type="text" class="form-control form-white input-modal"  id="email1" value="Email Address">
